...
values."
  (setq-default
   ...
   '(
     ...
     ;;          wakatime-cli-path "/Users/mobrien/.pyenv/shims/wakatime")
     )
...
you should place your code here."
  ...
  ;; save buffers every 30 seconds of inactivity
  ...
  (defun hmo/org-mode-configuration ()
    ;; add leader key for helm org rifle
    (spacemacs/set-leader-keys "aor" 'helm-org-rifle-agenda-files)
    (spacemacs/set-leader-keys "aon" 'hmov/notes)
